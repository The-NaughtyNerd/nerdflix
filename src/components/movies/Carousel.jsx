...
const Carousel = ({ img, title, year, genre, watchtime }) => {
  return (
    ...
    >
      <div className="backdrop-filter backdrop-blur-sm bg-[#111111] bg-opacity-40 w-full p-8 flex flex-col justify-end items-start rounded-t-[2rem] gap-6 sm:gap-0 sm:flex-row sm:justify-between sm:items-end sm:p-16 sm:rounded-none sm:backdrop-filter-none sm:backdrop-blur-none sm:bg-none sm:bg-opacity-0">
        <div className="">
